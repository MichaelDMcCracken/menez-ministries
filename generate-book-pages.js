...
<script>
    (function () {
        ...
        function parsePassageRef(passage) {
            ...
            // Match the chapter (and optional verse) that follows the book name.
            // Using \\s as a prefix skips a leading book-number like "1" in "1 Corinthians 2:5".
            var m = passage.match(/\\s(\\d+)(?::(\\d+))?/);
